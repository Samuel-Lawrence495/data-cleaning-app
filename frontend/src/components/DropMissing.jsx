...
const API_DROP_MISSING_ALL_URL = 'http://localhost:8000/data_cleaning_app/dataframe/ops/drop-missing-rows-all/';
    ...
    return (
        <div>
            ...
            <button
                ...
                title={!currentSheetData || !currentSheetData.filename ? "Upload a file first" : "Remove rows that contain any missing values"}
            >
                {isProcessing ? 'Processing...' : 'Drop Rows with All Missing Values'}
            </button>
        </div>
    );
}
