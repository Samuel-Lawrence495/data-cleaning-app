...
from .views import EncodingView, FilterRowsView, ManageDataFrameView, HandleMissingRowsView, ReplaceMissingValuesView
...
urlpatterns = [
    ...
    path('dataframe/ops/encode/', EncodingView.as_view(), name='op-encode'),
]